...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center; margin-top:100px;">Seul Au Monde "Cast Way"</h1>
        </div>
            
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <img src="filmsforsite/cast-way.jpg" alt="affiche film Cast Way" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/cast-way.jpg" alt="affiche film Cast Way" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/cast-way.jpg" alt="affiche film Cast Way" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/cast-way.jpg" alt="affiche film Cast Way" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col-md-4" style="text-align:justify;">
                    <p>SChuck Noland, un cadre de Fedex, la veille de Noël, il reçoit un appel lui annonçant qu'il doit contrôler la livraison d'un colis urgent pour la Malaisie. <br>
                       Il n'en a que pour quatre jours , il quitte Los Angeles à bord d'un petit avion. <br>
                       Mais au-dessus de l'Océan Pacifique, un orage éclate et prend par surprise l'équipage, le crash est inévitable.<br>
                       SChuck s'échoue sur une île déserte. Les jours passent et aucun secours en vue.
                       Pendant quatre ans, le naufragé va tenter de s'adapter à cet environnement sauvage...
                    <br> <br>
                    <strong>Acteurs principaux :  Tom Hanks, Helen Hunt, Nick Searcy</strong>
                    </div>        
                    <div  class="col-md-4">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/pgOYHJbaV2c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
            </div>
            </div>
