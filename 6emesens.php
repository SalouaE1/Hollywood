...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center; margin-top:100px;">6éme Sens</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <img src="filmsforsite/6emesens.jpg" alt="affiche film 6emesens" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/6emesens.jpg" alt="affiche film 6emesens" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/6emesens.jpg" alt="affiche film 6emesens" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/6emesens.jpg" alt="affiche film 6emesens" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col-md-4" style="text-align:justify;">
                    Dr. Malcolm Crowe, un psychologue pour enfants qui tente d'aider un jeune garçon nommé Cole Sear, Cole prétend voir des fantômes et est perturbé par ces expériences. <br>
                    Le psychologue s'efforce de comprendre la situation de Cole tout en naviguant dans ses propres problèmes personnels.<br>
                    "Sixième Sens" est particulièrement célèbre pour son twist final inattendu...
                    <br><br>
                    <strong>Acteur principal : Bruce Willis -Haley Joel OsmentToni - Toni Collette</strong>
                    </div>
                    <div  class="col-md-4">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/HEd92ksuHNo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
